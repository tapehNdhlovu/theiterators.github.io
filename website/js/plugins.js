        ...
        i = {
            init: function(a) {
                a = t.extend({
                    ...
                    timer: !1,
                    data: {
                        inClass: "animation-in-class",
                        inDuration: "animation-in-duration",
                        outClass: "animation-out-class",
                        outDuration: "animation-out-duration",
                        overlay: "animation-overlay"
                    },
                    events: {
                        inStart: "animation.inStart",
                        inEnd: "animation.inEnd",
                        outStart: "animation.outStart",
                        outEnd: "animation.outEnd"
                    }
                };
                ...
                return o || !(a.browser.length > 0) || o && this.length ? (i.optionCheck.call(this, a) && t("." + a.overlayClass).length <= 0 && i.addOverlay.call(this, a), a.loading && t("." + a.loadingClass).length <= 0 && i.addLoading.call(this, a), this.each(function() {
                    ...
                    }), s.on("unload." + n, function() {}), l.on("click." + n, a.linkElement, function(n) {
                        n.preventDefault();
                        var a = t(this),
                            e = a.attr("href");
                    ...
                    return t
                }), this.length || console.log("animation: Element does not exist on page."), o || console.log("animation: Does not support this browser."), i.destroy.call(this))
            },
            ...
            in: function() {
                var a = this,
                    ...
                    c = o.data(n).outClass;
                e.loading && i.removeLoading.call(a), c && o.removeClass(c), u ? i.inOverlay.call(a, d, r) : i.inDefault.call(a, d, r)
            },
            ...
            out: function(a, o) {
                ...
                s.data(n).outClass = f, v ? i.outOverlay.call(e, f, h, o) : i.outDefault.call(e, f, h, o)
            },
...
jQuery(document).ready(function(i) {
    if (i(window).width() > 1170) {
        ...
        i(window).on("scroll", {
            ...
            e < this.previousTop ? e > 0 && i(".cd-header").hasClass("is-fixed") ? i(".cd-header").addClass("is-visible") : i(".cd-header").removeClass("is-visible is-fixed") : (i(".cd-header").removeClass("is-visible"), e > s && !i(".cd-header").hasClass("is-fixed") && i(".cd-header").addClass("is-fixed")), this.previousTop = e
        })
    }
    i(".cd-primary-nav-trigger").on("click", function() {
        i(".cd-menu-icon").toggleClass("is-clicked"), i(".cd-header").toggleClass("menu-is-open"), i(".cd-primary-nav").hasClass("is-visible") ? i(".cd-primary-nav").removeClass("is-visible").one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend", function() {
            i("body").removeClass("overflow-hidden")
        }) : i(".cd-primary-nav").addClass("is-visible").one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend", function() {
